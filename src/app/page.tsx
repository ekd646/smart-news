  ...
  return (
    <div className="bg-[#131315] min-h-screen text-[#e5e1e4] font-sans selection:bg-[#d97a53] selection:text-white">
            ...
            >
              ...
              {modalMode === "signup" && (
                <div className="animate-fade-in-up">
                  ...
                  <p className="text-[#dbc1b8] text-center mb-6 text-sm">Join Pactum AI for elite market access.</p>
                  <div className="space-y-4 mb-6">
              ...
              {modalMode === "privacy" && (
                <div className="animate-fade-in-up max-h-[60vh] overflow-y-auto pr-4 scrollbar-hide">
                  ...
                  <div className="space-y-4 text-sm text-[#dbc1b8] leading-relaxed">
                    ...
                    <p>At Pactum AI, we are committed to protecting your privacy and ensuring the security of your personal data. This Privacy Policy outlines how we collect, use, and safeguard your information.</p>
              ...
              {modalMode === "terms" && (
                <div className="animate-fade-in-up max-h-[60vh] overflow-y-auto pr-4 scrollbar-hide">
                  ...
                  <div className="space-y-4 text-sm text-[#dbc1b8] leading-relaxed">
                    ...
                    <p>By accessing the Pactum AI platform and our proprietary Market Intelligence nodes, you agree to be bound by these Terms of Service.</p>
                    ...
                    <p>Pactum AI shall not be held liable for any financial losses or trading liquidations arising from the use of our intelligence division insights.</p>
                  </div>
                </div>
              )}
              ...
              {modalMode === "cookie" && (
                <div className="animate-fade-in-up max-h-[60vh] overflow-y-auto pr-4 scrollbar-hide">
                  ...
                  <div className="space-y-4 text-sm text-[#dbc1b8] leading-relaxed">
                    <p><strong>Effective Date: March 2026</strong></p>
                    <p>Pactum AI uses cookies and similar tracking technologies to track activity on our SaaS architecture and hold certain high-frequency information.</p>
      ...
      <motion.footer initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="pt-12 pb-24 border-t border-white/5 flex flex-col items-center justify-center gap-8 bg-[#131315]">
        ...
        <div className="text-[#a38c84]/50 text-[10px]">© 2026 Pactum AI All rights reserved. Architected for Scale.</div>
      </motion.footer>
    </div>
  );
}
